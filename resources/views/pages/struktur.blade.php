                            ...
                            <div class="col-md-5 col-sm-8">
                                <div class="member-card">
                                    ...
                                    <div class="member-info">
                                        ...
                                        <a href="https://www.instagram.com/oktariawanindra?igsh=MWNkZG1kZGE1NHZrZg==" class="btn btn-sm btn-danger">{{ __('site.struktur.instagram') }}</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-5 col-sm-8">
...
" class="btn btn-sm btn-danger">{{ __('site.struktur.instagram') }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-5 col-sm-8">
                                <div class="member-card">
                                    ...
                                    <div class="member-info">
                                        ...
                                        <a href="https://www.instagram.com/__putriwardha?igsh=MXh6NThjZWxha3BhaA==" class="btn btn-sm btn-danger">{{ __('site.struktur.instagram') }}</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-5 col-sm-8">
                            ...
                            <div class="col-md-5 col-sm-8">
                                <div class="member-card">
                                    ...
                                    <div class="member-info">
                                        ...
                                        <a href="#" class="btn btn-sm btn-danger">{{ __('site.struktur.instagram') }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
