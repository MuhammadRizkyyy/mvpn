...
<div class="mb-6 flex items-center justify-between">
    ...
    <a href="{{ route('admin.pengurus-sections.index') }}"
...
@foreach($sections as $section)
    @php $key = $section->slug; $label = $section->name; $items = $pengurus->get($key, collect()); @endphp
    ...
    <div class="overflow-hidden rounded-xl border border-neutral-200 bg-white">
        ...
        @else
            <ul class="divide-y divide-neutral-100" data-reorder-url="{{ route('admin.pengurus.reorder') }}" data-reorder-key="section" data-reorder-value="{{ $key }}">
