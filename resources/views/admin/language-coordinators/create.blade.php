...
<div class="max-w-xl overflow-hidden rounded-xl border border-neutral-200 bg-white">
    <div class="border-b border-neutral-200 px-6 py-4">
        <h1 class="font-display text-lg font-semibold text-neutral-950">Tambah Penanggung Jawab</h1>
    </div>

    <form method="POST" action="{{ route('admin.language-coordinators.store') }}" enctype="multipart/form-data" class="space-y-4 px-6 py-5">
        @csrf
        @include('admin.language-coordinators._form')
