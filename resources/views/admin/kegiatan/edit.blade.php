...
<div class="max-w-xl overflow-hidden rounded-xl border border-neutral-200 bg-white">
    <div class="border-b border-neutral-200 px-6 py-4">
        <h1 class="font-display text-lg font-semibold text-neutral-950">Edit Program Kerja</h1>
    </div>

    <form method="POST" action="{{ route('admin.kegiatan.update', $kegiatan) }}" class="space-y-4 px-6 py-5">
        @csrf
        @method('PUT')
