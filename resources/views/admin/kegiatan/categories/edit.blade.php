...
@section('title', 'Edit Tab Program Kerja')

@section('content')

<a href="{{ route('admin.kegiatan-categories.index') }}"
...
<div class="max-w-xl overflow-hidden rounded-xl border border-neutral-200 bg-white">
    <div class="border-b border-neutral-200 px-6 py-4">
        <h1 class="font-display text-lg font-semibold text-neutral-950">Edit Tab Program Kerja</h1>
    </div>

    <form method="POST" action="{{ route('admin.kegiatan-categories.update', $category) }}" class="space-y-4 px-6 py-5">
        @csrf
        @method('PUT')
        @include('admin.kegiatan.categories._form')
